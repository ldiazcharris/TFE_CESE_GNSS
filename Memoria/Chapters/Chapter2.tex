...
Este capítulo presenta en detalle los temas aplicados en el desarrollo del trabajo y las definiciones realizadas en el inicio de este. Permite conocer los requisitos y organización de tareas planteadas.
...
\begin{enumerate}
	\item Requerimientos funcionales
		\begin{enumerate}
			...
			\item La exactitud del reporte de la posición geográfica debe ser de diez metros (10 m). 
...
\begin{table}[h]
    ...
    \toprule
        ...
        Soporte de hardware para RTOS & Sí        & No 16 (Analog)           & Sí                                 \\
    \bottomrule
    \hline
    \end{tabular}
...
\begin{itemize}
    ...
    \item Debido a que es un producto \textit{Open Source} y \textit{Open Hardware}, goza de una comunidad de desarrolladores bastante activa y una gran disponibilidad de documentación. Estas dos características posibilitan que cualquier inconveniente que se presente tenga una alta probabilidad de ser resuelto.  
...
\subsection{Módulo 4G SIM A7670SA}
...
Para el presente trabajo se utilizó el módulo A7670SA 4G LTE CAT1 MULTIBANDA GSM GPRS IOT (ver figura~\ref{fig:A7670SA_2}) comercial basado en el SoC SIM A7670SA, debido a la facilidad para integrarlo al sistema general. Además, dispone de las interfaces de hardware necesarias para su interconexión con la ESP32, incluye su propio circuito de alimentación y un diseño fiable para evitar las interferencias electromagnéticas.

\begin{figure}[htbp]
	\centering
	\includegraphics[width=.25\textwidth]{./Figures/A7670SA_Mod.jpg}
...
La antena está diseñada para la recepción de señales de la constelación GPS y BeiDou (BD) y presenta las siguientes características eléctricas: 
...
FreeRTOS™ es un sistema operativo de tiempo real de código abierto diseñado para sistemas embebidos y microcontroladores. Es apto para microcontroladores y microprocesadores pequeños \citep{FreeRTOS}. Las ventajas de haber implementado este sistema operativo en el trabajo son las siguientes:
...
\subsection{Servicios web para mapas}
\label{sec:mapas_web}

Un servicio de mapas es un conjunto de herramientas y servicios de software que permiten que los mapas estén disponibles en la web. 
...
\begin{table}[h]
    \centering
    \caption{Tabla comparativa de API's de mapas.}
    \begin{tabular}{p{3cm} p{3cm} p{2.5cm} p{2.5cm} }
    \toprule
        ...
        Características avanzadas & Geocoding, Directions, Distance Matrix, Places API, etc. & Depende de plugins externos. & Análisis espacial avanzado, mapas temáticos, SQL API. \\

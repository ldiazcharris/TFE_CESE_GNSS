...
\item Los requerimientos del trabajo se cumplieron en un 90\% debido a que no se pudo cumplir con la exactitud de 10 m. Esta exactitud se cumple mientras el dispositivo se encuentra en la calle o lugares despejados; sin embargo, cuando el dispositivo se encuentra al interior de un edificio la exactitud baja considerablemente al rededor de 50 m. 
...
\item Se manifestó el riesgo 1 \textit{'daño o deterioro inesperado de los módulos de hardware'}. Las medidas de mitigación fueron efectivas. Específicamente se tuvo que cambiar el módulo de comunicación GPRS/GSM Quectel M95, que estaba previsto en la planificación, por el módulo 4G SIM A7670SA. Esto debido a los cambios en la infraestructura de comunicaciones en Colombia, donde se descontinuó el uso de comunicaciones 2G. Lo anterior causó que se desechara el trabajo adelantado con el módulo M95 e impacto con retrasos en el trabajo. 

\item debido a lo anterior, también se manifestó el riesgo riesgo 4 \textit{'trabajos no planificados por fallas en el análisis'}, debido a que no se consideró correctamente la tecnología de telecomunicaciones a utilizar.

\item Se manifestó el riesgo 5 \textit{'extensión del proyecto más allá del plazo establecido'}. El plan de mitigación no fue efectivo, debido a variables incontrolables como: nueva carga laboral y sucesos otros imprevistos. Habría sido prudente analizar mejor la situación con respecto a los requerimientos para ajustar el alcance del trabajo.

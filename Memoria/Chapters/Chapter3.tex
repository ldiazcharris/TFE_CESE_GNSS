...
El código HTML inicia con la declaración del tipo de documento (<!DOCTYPE html>), ya que se trata de un archivo HTML5. Luego, se abre la etiqueta <html> que contiene todo la página web.
...
\item La función \textit{set\_cava\_position\_map} se encarga de actualizar el mapa con la nueva posición de la cava. Primero, actualiza elementos HTML con los nuevos valores de latitud y longitud. Si ya existe un marcador, lo elimina del mapa. Luego, crea un nuevo marcador en la nueva posición y añade un \textit{popup} con la información de esta posición. Además, añade la nueva posición a la lista path y dibuja un rastro en el mapa utilizando esta lista. Finalmente, ajusta la vista del mapa para centrarlo en la nueva posición.

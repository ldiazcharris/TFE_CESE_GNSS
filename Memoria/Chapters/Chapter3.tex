...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{./Figures/Diagrama_flujo_firmware_TFE_CESE_Part_1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{./Figures/Diagrama_flujo_firmware_TFE_CESE_Part_2.png}

...
\item Evaluar la exactitud de la geolocalización GNSS. Medir la exactitud de las coordenadas proporcionadas por el módulo GNSS y compararlas con un patrón de referencia.
...
\begin{enumerate}
\item Para esta prueba se requiere el uso del puerto UART\_1, por lo tanto, se intercambias los pines GND, Vin, Tx y Rx del módulo Quectel L76 en la ranura del módulo SIM A7670SA. Debido a que son conectores diferentes se deben emplear cables de prueba.
...
En la figura \ref{fig:pru_A7670_transm} se muestra otra captura de mensajes visualizados en la terminal \textit{Hercules}. En esta captura se muestra la transmisión del comando \textbf{AT+CMGD=1,4} hacia el módulo SIM A7670SA, este comando debe cumplir con las siguientes condiciones: 
